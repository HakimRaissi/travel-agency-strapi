...
export interface ApiChildrenPriceChildrenPrice
  extends Struct.CollectionTypeSchema {
  collectionName: 'children_prices';
  info: {
    displayName: 'Children Price';
    pluralName: 'children-prices';
    singularName: 'children-price';
  };
  options: {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    end: Schema.Attribute.Decimal & Schema.Attribute.Required;
    identification: Schema.Attribute.String & Schema.Attribute.Unique;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::children-price.children-price'
    > &
      Schema.Attribute.Private;
    note: Schema.Attribute.String;
    price: Schema.Attribute.Integer & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    start: Schema.Attribute.Decimal & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiPackPack extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    main_image: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    perklist: Schema.Attribute.JSON &
      Schema.Attribute.CustomField<
        ...
        [
          ...
          'Shuttle:shuttle',
          'Formula (All Inclusive):formula-all-inclusive',
          'Formula (Half Board):formula-half-board',
          'Formula (Breakfast Only):formula-breakfast-only',
        ]
      > &
      Schema.Attribute.DefaultTo<'[]'>;
...
export interface ApiPricePrice extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    child_prices: Schema.Attribute.Relation<
      'oneToMany',
      'api::children-price.children-price'
    >;
    ...
    triple: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
